...
@Repository
public class DeductionDataRepositoryImpl implements DeductionDataRepository {
...
//			+ "WHERE g.payperiod = ? AND f.businessunitid = ? AND f.status = 1001";
	...
	private static final String DEDUCTION_QUERY="SELECT componentid, componentvalue\r\n"
			+ "FROM hclhrm_prod.tbl_employee_deductions a\r\n"
	...
	@Override
	public List<Object[]> DeductionQueryForEmployee(int employeeId, String payPeriod, int businessUnitId) {
		//System.err.println(employeeId);
		return jdbcTemplate.query(DEDUCTION_QUERY, new Object[] { businessUnitId, payPeriod, employeeId },
